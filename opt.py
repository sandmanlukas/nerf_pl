...
def get_opts():
    ...
    parser.add_argument("--mask_path", type=str, help="path to mask")
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="train or test. if test, trains on left half of images, tests on right half",
    )
    ...
    parser.add_argument(
        "--N_a", type=int, default=48, help="number of embeddings for appearance"
    )
    parser.add_argument(
        "--encode_t",
        default=False,
